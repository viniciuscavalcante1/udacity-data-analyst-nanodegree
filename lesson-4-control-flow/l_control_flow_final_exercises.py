...
print("Question 1:")
print("A. Create a dictionary that includes the count of Oscar nominations"
...
for years, directors in nominated.items():
...
screen_split()
print("B. Provide a dictionary with the count of Oscar wins for each director in the winners list.")
...
for years, directors in winners.items():
    for director in directors:
...
screen_split()
print("Question 2:")
print("Provide a list with the name(s) of the director(s) with the most Oscar wins."
